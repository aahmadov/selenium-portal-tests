...
public class Client_License_data extends TestBase {
    ...
    @Test(priority = 1, testName = "Portal:Data Edit Issue", groups = {"Regression46"})
    public void Client_License_data_edit46() throws InterruptedException, AWTException, SQLException {
        //driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        System.out.println("Test case name" + testName);
