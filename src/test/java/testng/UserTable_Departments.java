...
public class UserTable_Departments extends TestBase {
    ...
    @Test(priority = 1, testName = "Create user and assign user to department", groups = {"Regression46"})
    public void DepartmentAdminUserTable46() throws InterruptedException {
