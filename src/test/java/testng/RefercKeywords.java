...
//        loginPageObj.claimNumber.sendKeys(data.get("claimNumber"));
    ...
    @Test(priority = 1, testName = "Portal:Specify_Reference_Keywords", groups = {"Regression46"})
    public void Specify_Reference_Keywords46() throws InterruptedException, AWTException, SQLException {
...
//        loginPageObj.claimNumber.sendKeys(data.get("claimNumber"));
        ...
        if (message.contains("Your fax request has been accepted")) {
            ...
            String query1 = "SELECT ProjectCode1,JobID FROM auto1.sendstatus order by JobID desc limit 1;";
            DataBaseUTIL.executeSQLQuery46(query1);
            DriverFactory.closeDriver();
...
//        Thread.sleep(1000 * 2);
    ...
    @Test(priority = 2, testName = "Portal:Specify_Send_After", groups = {"Regression46"})
    public void Specify_Send_After46() throws InterruptedException, AWTException, SQLException {
