...
public class CreateDepartment extends TestBase {
    ...
    @Test(priority = 1, testName = "Portal:Create Department ", groups = {"Regression46"})
    public void Create_Department46() throws InterruptedException, AWTException, SQLException {
        //driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        System.out.println("Test case name" + testName);
